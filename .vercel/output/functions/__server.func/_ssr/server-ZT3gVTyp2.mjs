...
import { i as __exportAll, n as createCsrfMiddleware } from "./server-ZT3gVTyp.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C9NC62Wj.mjs");
...
var manifest = { "f72b330b38ac789618e9f4713b98dbf37cbee40ae98763ad4bf5fc4980654083": {
	functionName: "predictExpiryRisk_createServerFn_handler",
	importer: () => import("./predict.functions-sYu_BrUz.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DNXHUjnj.mjs").then((n) => n.t),
